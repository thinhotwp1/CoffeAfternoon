package thinhld.ldt.customerservice.rest;
...
//        restTemplate.setRequestFactory(requestFactory);
     ...
     * @param <T> Kiểu trả về
     */
    public <T> T postObject(Object o, Class<T> tClass) throws RestClientException {
        return restTemplate.postForObject(url+nameSpace+path, o, tClass);
    }
    public <T> T getObject(Class<T> tClass) throws RestClientException {
        return restTemplate.getForObject(url+nameSpace+path, tClass);
    }
